...
public class MountainRepositoryTest extends RepositoryContext {
    ...
    class 조회용_테스트{
        ...
        void 관심사에_맞는_산을_조회한다(Interest interest){
            ...
            //when
            List<MountainEntity> interestingMountains = mountainRepository.findByInterest(interest);

            //then
            assertThat(interestingMountains).extracting(MountainEntity::getInterest).containsExactlyInAnyOrder(interest);
        }
    ...
    class 저장용_테스트{
        ...
        void 산을_저장한다(){
            ...
            //then
            assertThat(mountainRepository.findAllCount()).isEqualTo(mountainCount);
