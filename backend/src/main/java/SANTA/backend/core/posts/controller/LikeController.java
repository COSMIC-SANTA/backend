...
public class LikeController {
    ...
    public ResponseEntity<ResponseHandler<Map<String, Object>>> toggleLike(@PathVariable("postId") Long postId) {
    ...
    public ResponseEntity<ResponseHandler<Map<String, Object>>> commentLike(@PathVariable("commentId") Long commentId) {
        log.info("@@ 좋아요 추가 취소 실행");
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal();
        User user = userDetails.getUser();
    ...
    public ResponseEntity<ResponseHandler<Map<String, Object>>> countLikes(@PathVariable("postId") Long postId) {
    ...
    public ResponseEntity<ResponseHandler<Map<String, Object>>> commentcountLikes(@PathVariable("commentId") Long commentId) {
