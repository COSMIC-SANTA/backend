...
public class BookmarkController {
    ...
    public ResponseEntity<Map<String, Object>> toggleBookmark(@PathVariable("postId") Long postId) {
    ...
    public ResponseEntity<List<BookmarkPostDTO>> getBookmarkedPosts(@AuthenticationPrincipal CustomUserDetails userDetails) {
